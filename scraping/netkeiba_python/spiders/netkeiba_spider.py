...
DATA_MIN = '20101231'
KEYS = ['order', 'frame', 'horse_num', 'name', 'age', 'jockey-weight', 'jockey', 'time',
        'difference', 'time-metric', 'passed', 'last-spurt', 'odds', 'popularity',
        'horse-weight', 'train-time', 'comments', 'remarks', 'trainer', 'owner', 'prise']
